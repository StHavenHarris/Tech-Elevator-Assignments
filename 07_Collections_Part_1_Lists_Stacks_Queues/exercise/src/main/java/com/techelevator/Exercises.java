...
public class Exercises {
	...
	public List<String> array2List(String[] stringArray) {
		...
		for (String array3: stringArray){
			array2List.add(array3);
		}
		return array2List; //return the array
	}
	...
	public List<String> no4LetterWords(String[] stringArray) {
		List<String> noLongerThan4 = new ArrayList<String>();

		for (String words: stringArray){
			if (words.length() != 4 ){

				noLongerThan4.add(words);
			}

		}

		return noLongerThan4;
	}
	...
	public List<Double> arrayInt2ListDouble(int[] intArray) {
		List<Double> intoDoubles = new ArrayList<Double>();

		for (Integer willDivide: intArray) {
			intoDoubles.add(willDivide /2.0 );
		}
	...
	public List<Integer> oddOnly(Integer[] integerArray) {
		...
		List<Integer> giveOddnum = new ArrayList<Integer>();

		for (Integer giveTheOdds: integerArray){

			if (giveTheOdds % 2 != 0){
				giveOddnum.add(giveTheOdds);
			}
	...
	public boolean foundIntTwice(List<Integer> integerList, int intToFind) {
		...
		for (Integer NumTwice: integerList ){
			if (NumTwice == intToFind){
				numcount++;
	...
	public List<String> fizzBuzzList(Integer[] integerArray) {
		...
		for (Integer checkForFizzBuzz: integerArray){
			if (checkForFizzBuzz % 3 == 0 && checkForFizzBuzz % 5 == 0){
				...
				fizzList.add(checkForFizzBuzz.toString());
			}
		}
