...
public class Exercises {
	...
	public String makeTags(String tag, String word)
	{
		String firstTag =  "<"+tag+">";
		String lastTag = "</"+tag+">";
		String webWord = firstTag+word+lastTag;
		return webWord;
	}
	...
	public String makeOutWord(String out, String word) {
		...
		String finalWord = str+word+str2;
	...
	public String withoutEnd(String str) {
		int stringLegnth = str.length();
		return str.substring(1,stringLegnth-1);
	...
	public String middleTwo(String str) {
		...
		return str.substring(lengthStr -1, lengthStr+1);
	...
	public String middleThree(String str) {
		...
		return str.substring(lengthStr -1, lengthStr+2);
	}
	...
	public String stringBits(String str) {
		int lengthOfBits = str.length();
		String tempString = "";

		for (int i = 0; i <lengthOfBits; i = i + 2){
	...
	public int last2(String str) {
		...
		for (int i=0; i < str.length()-2; i++){
			String end2 = str.substring(i, i +2);

			if (end2.equals(endOfStr)){
				count++;
