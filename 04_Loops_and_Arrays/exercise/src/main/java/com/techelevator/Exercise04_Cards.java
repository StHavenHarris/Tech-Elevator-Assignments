...
public class Exercise04_Cards {
    ...
    */
    ...
    public String[] discardFirstCard(String[] hand) {
        String newCard[] = new String[hand.length - 1];
    ...
    public String[] discardTopCard(String[] remainingDeck) {
        ...
        String cardGraveyard[] = new String[remainingDeck.length -1];

        for (int i = 1; i < remainingDeck.length && i > 0; i ++){
            if(remainingDeck.length > 0) {
                cardGraveyard[i - 1] = remainingDeck[i];
            }
