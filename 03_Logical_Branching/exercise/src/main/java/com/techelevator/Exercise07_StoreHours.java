...
public class Exercise07_StoreHours {
    ...
    public boolean isStoreOpen(int currentHour, char currentDay) {
        if (currentHour < 17 && currentHour > 7 && (currentDay == 'M' || currentDay == 'W' || currentDay == 'F') )
        {
    ...
    public static void main(String[]args) {
        Exercise07_StoreHours object = new Exercise07_StoreHours();
        System.out.println(object.isStoreOpen(17, 'W') + " false");
    }
    ...
    public boolean isStoreOpen(int currentHour, char currentDay, boolean isSummer) {
        ...
        if (currentHour < 20 && currentHour > 7 && (currentDay == 'W') && isSummer == true) {
            return true;
        }

        {
            if (currentHour < 15 && currentHour > 8 && (currentDay == 'S') && isSummer == true) {
